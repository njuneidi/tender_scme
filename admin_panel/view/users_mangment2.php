        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>
                        <?PHP echo $init::USER_MANGEMEMT_PAGE ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" value="<?= $student['id']; ?>"
                                        class="viewStudentBtn btn btn-info btn-sm"> <?PHP echo $init::VIEW ?></button>
                                    <button type="button" value="<?= $student['id']; ?>"
                                        class="editStudentBtn btn btn-success btn-sm"> <?PHP echo $init::EDIT ?></button>
                                    <button type="button" value="<?= $student['id']; ?>"
                                        class="deleteStudentBtn btn btn-danger btn-sm"> <?PHP echo $init::DELETE ?></button>
                                </td>
                            </tr>
                            <?php
                            //   }
