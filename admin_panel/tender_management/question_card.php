            ...
            <div class="col-md-12">
                <table class="table table-bordered" id="myTable">
                    ...
                    <tbody id="table-body">
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <button id="addNewQ" type="button" class="btn btn-link"
                                            data-bs-toggle="collapse" data-bs-target="#add-question-to-the-bank"
                                            aria-expanded="false">
                        ...
                        <div class="d-felex justify-content-center d-none tender-question-continer">
                        </div>
...
<!-- <script src="../../tender_scme/assets/js/scripts.js"></script> -->
